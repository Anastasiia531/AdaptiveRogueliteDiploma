...
public class MiniMap : MonoBehaviour
{
    ...
    public void CreateMiniMap()
    {
        ...
        for (int i = 0; i < miniRoomNode.childCount; i++)
        {
            Destroy(miniRoomNode.GetChild(i).gameObject);
        }
        miniRoomNode.transform.localPosition = new Vector3(0, 0, 0);
